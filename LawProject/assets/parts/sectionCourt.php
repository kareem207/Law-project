...
if ( isset($_SESSION['phoneNum']) ){
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="reForm" method = "post" >
        ...
        <div class="form-row my-1"> <input type="tel" class="form-control" placeholder="رقم القرار" name="inServiceNum" required="required"> </div>
        <div class="form-row my-1">
          <select id="inputState" class="form-control">
            <option value="1" selected>معرفه قرار</option>
          </select>
        </div>
          <div class="form-row my-1"> <input type="text" class="form-control" placeholder="اسماء الخصوم" name="inVsName"> </div>
          <div class="form-row">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">تحذيز</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer">
        <a  class="btn btn-primary" href="registeration.php">تسجيل مستخدم جديد</a>
        <a  class="btn btn-primary" href="login.php">تسجيل الدخول</a>
      </div>
    </div>
  </div>
</div>';}
